...
% ARC asks: "not flagged as bad" --> what exactly do we mean here? ASPCAPFLAG = 0?
...
$\bullet$~Starting at some guess for $K$ $D$-space cluster centers ($K$
locations in the $D$-dimensional space), assign each point in the
space (each star in our case) to the closest of the $K$ centers.
$\bullet$~Given that assignment of stars to centers, update each center (each of
the $K$ $D$-space positions) by taking the mean of the locations of
the stars assigned to that center.
Iterate the assignment and mean steps to convergence.
...
precisions obtained by \thecannon\ before running k-means.\footnote{The scalings were DWH DWH.}
...
% ARC TO DO: Make claim of the fourth being M53.
...
% ARC to DWH: Are the colors of broken glass indicative of anything?
...
% The high-velocity-dispersion structure in the Galaxy halo.
...
Bovy,~J., 2015, arXiv:1510.06745
 \bibitem[Briley \etal(2004)]{Briley_2004} Briley, M.~M., Cohen, 
J.~G., \& Stetson, P.~B.\ 2004, \aj, 127, 1579 
\bibitem[Casey \etal(2016)]{casey16}
Casey,~A.~R., Hogg,~D.~W., Ness,~M., Rix,~H.-W., 2016, in preparation
\bibitem[Cohen \& Mel{\'e}ndez(2005)]{Cohen_Melendez_2005} Cohen, J.~G., \& Mel{\'e}ndez, J.\ 2005, \aj, 129, 303 
...
\bibitem[Geisler \etal(1997)]{Geisler_1997} Geisler, D., Claria, 
J.~J., \& Minniti, D.\ 1997, \pasp, 109, 799 
...
\bibitem[Johnson \& Pilachowski(2012)]{Johnson_Pilachowski_2012} Johnson, C.~I., \& Pilachowski, C.~A.\ 2012, \apjl, 754, L38 
\bibitem[Kraft \etal(1992)]{Kraft_1992} Kraft, R.~P., Sneden, C., Langer, G.~E., \& Prosser, C.~F.\ 1992, \aj, 104, 645 
\bibitem[Kuzma \etal(2015)]{Kuzma_2015} Kuzma, P.~B., Da Costa, 
G.~S., Keller, S.~C., \& Maunder, E.\ 2015, \mnras, 446, 3297 
...
\bibitem[Smith(1985)]{Smith_1985} Smith, G.~H.\ 1985, \apj, 298, 
249 
\bibitem[Smith \etal(2002)]{Smith_2002} Smith, G.~H., Sneden, C., 
\& Kraft, R.~P.\ 2002, \aj, 123, 1502 
\bibitem[Smith \etal(2005)]{Smith_2005} Smith, G.~H., Briley, 
