...
\begin{abstract}
% Context:
Chemical tagging promises to use surface chemical abundance measurements to find sets of stars
that were born together but which are now in spatially extended distributions.
...
delivering $\geq 15$ individual abundances for $\sim 10^5$ stars with precisions around 0.04~dex.
% Aims:
