...
This makes the space close to isotropic in measurment uncertainty or
observational precision.

When the k-means results are returned, we construct the $D\times D$ empirical variance tensor for the DWH THIS IS WRONG!
