...
HOGG: Paragraph here about limitations of \thecannon: Dependence on
training set, makes use of element-element correlations (especially, say, Na),
and delivers precision but no guarantees of accuracy beyond that in the training set.
Comment on its performance at the edges of the abundance distribution...? As per referee issue.
